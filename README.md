...
Use it only after proving that a separately governed CI credential can mint the
exact organization runner-group JIT endpoint. Do not repurpose a registry,
